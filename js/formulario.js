document.addEventListener('DOMContentLoaded', function () {
    ...
    if (orbContainer) {
        ...
        const orbs = [
            { el: document.getElementById('orb-one'), x: containerWidth * 0.1, y: containerHeight * 0.1, dx: 1.2, dy: 1.0 },
            { el: document.getElementById('orb-two'), x: containerWidth * 0.7, y: containerHeight * 0.6, dx: -1.0, dy: 0.8 },
            { el: document.getElementById('orb-three'), x: containerWidth * 0.4, y: containerHeight * 0.8, dx: 0.8, dy: -1.2 },
            { el: document.getElementById('orb-four'), x: containerWidth * 0.9, y: containerHeight * 0.2, dx: -0.8, dy: -1.0 }
        ];
